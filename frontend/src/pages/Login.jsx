            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="w-full pl-10 px-4 py-2 border border-secondary-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
            ...
            <div>
              ...
              >
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  <FaArrowRight className="h-5 w-5 text-primary-400 group-hover:text-primary-300" aria-hidden="true" />
                </span>
                Sign in
              </button>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                ...
                >
                  <a href="#" className="text-secondary-300 hover:text-black">
                <FaGoogle size={30} />
                </a>
                </button>
              </div>
